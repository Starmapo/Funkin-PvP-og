...
class NoteSplash extends FlxSprite
{
	...
	public function setupNoteSplash(x:Float = 0, y:Float = 0, note:Note = null, texture:String = null, hueColor:Float = 0, satColor:Float = 0,
			brtColor:Float = 0, keyAmount:Int = 4)
	{
		if (note != null)
		{
			daNote = note;
