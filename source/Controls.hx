	...
	public function setKeyboardScheme(scheme:KeyboardScheme, reset = true)
	{
		...
		switch (scheme)
		{
			case Solo:
				...
				inline bindKeys(Control.NOTE_LEFT, keysMap.get('note4_0'));
				inline bindKeys(Control.NOTE_DOWN, keysMap.get('note4_1'));
				inline bindKeys(Control.NOTE_UP, keysMap.get('note4_2'));
			...
			case Duo(true):
				...
				inline bindKeys(Control.NOTE_UP, [D]);
				inline bindKeys(Control.NOTE_RIGHT, [F]);
